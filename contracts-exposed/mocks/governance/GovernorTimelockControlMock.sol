...
contract $GovernorTimelockControlMock is GovernorTimelockControlMock {
    ...
    function $_cancel(address[] calldata targets,uint256[] calldata values,bytes[] calldata calldatas,bytes32 descriptionHash) external returns (uint256 proposalId) {
