...
abstract contract $GovernorCompatibilityBravo is GovernorCompatibilityBravo {
    ...
    function $_execute(uint256 arg0,address[] calldata targets,uint256[] calldata values,bytes[] calldata calldatas,bytes32 arg4) external {
        super._execute(arg0,targets,values,calldatas,arg4);
    }
