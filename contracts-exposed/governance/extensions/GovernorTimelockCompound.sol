...
abstract contract $GovernorTimelockCompound is GovernorTimelockCompound {
    ...
    function $_execute(uint256 proposalId,address[] calldata targets,uint256[] calldata values,bytes[] calldata calldatas,bytes32 arg4) external {
        super._execute(proposalId,targets,values,calldatas,arg4);
    }
